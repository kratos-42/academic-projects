...
void Translacao::getCatmullRomPoint(float t, int* indices, vector<Ponto> transP, float* res, float* deriv){
	float temp[4];
	float temp2[4];
	...
	//T*M
	temp[0] = vt[0]*m[0][0] + vt[1]*m[1][0] + vt[2]*m[2][0] + vt[3]*m[3][0];
	temp[1] = vt[0]*m[0][1] + vt[1]*m[1][1] + vt[2]*m[2][1] + vt[3]*m[3][1];
	temp[2] = vt[0]*m[0][2] + vt[1]*m[1][2] + vt[2]*m[2][2] + vt[3]*m[3][2];
	temp[3] = vt[0]*m[0][3] + vt[1]*m[1][3] + vt[2]*m[2][3] + vt[3]*m[3][3];
